...
export class Step2 extends TutorialStep {
  ...
  start() {
    ...
    ui.showHint("Now let's plant some corn!\nTap the Plants button to open the menu.", "corn");
  ...
  update() {
    const planted = this.manager.game.entities.entities.filter((e) => e.type === "corn").length;
