...
function createCorn() {
  ...
  loader.load(
    ...
    (gltf) => {
      const stage1 = gltf.scene.getObjectByName("corn_1");
      const stage2 = gltf.scene.getObjectByName("corn_2");
      const stage3 = gltf.scene.getObjectByName("corn_3");
    ...
    undefined,
    (error) => {
      console.error("Error loading corn.glb:", error);
    }
  );
