...
function createStrawberry() {
  ...
  loader.load(
    "/assets/models/strawberry.glb",
    (gltf) => {
      const stage1 = gltf.scene.getObjectByName("strawberry_1");
      const stage2 = gltf.scene.getObjectByName("strawberry_2");
      const stage3 = gltf.scene.getObjectByName("strawberry_3");
    ...
    undefined,
    (error) => {
      console.error("Error loading strawberry.glb:", error);
    }
  );
